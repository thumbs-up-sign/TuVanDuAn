...
;(function ($) {
    ...
    function Booklet(inTarget, inOptions) {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            updateOptions = function (newOptions) {
				...
				target.width(options.width);
				target.find('.bt-row').width(options.width/2);
                if(!options.height) {
					...
					options.height = Math.max.apply(null, target.find('.bt-row').map(function (){return $(this).height();}).get());
                }
            ...
            updatePercentageSize = function () {
                ...
                if(wPercent) {
                    ...
                    pWidthN = '-' + (pWidth) + 'px';
                    pWidthH = pWidth / 2;
					target.find('.bt-row').width(pWidth);
                }
                if(hPercent) {
    ...
    $.fn.booklet.defaults = {
        ...
        hoverWidth:           70,                              // default width for page-turn hover preview
