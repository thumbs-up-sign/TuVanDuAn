	...
	<ul class="category list-striped list-unstyled clearfix row">
		<?php foreach ($items as $i => $item) : ?>
			<?php if ($item->core_state == 0) : ?>
				<li class="system-unpublished col-md-4 col-sm-4 col-xs-12 cat-list-row<?php echo $i % 3; ?>">
			<?php else: ?>
				<li class="col-md-4 col-sm-4 col-xs-12 cat-list-row<?php echo $i % 3; ?> clearfix" >
