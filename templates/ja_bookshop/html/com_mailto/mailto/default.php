...
<div id="mailto-window">
	...
	<form action="<?php echo JUri::base() ?>index.php" id="mailtoForm" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label for="mailto_field" class="col-sm-2 col-xs-4 control-label"><?php echo JText::_('COM_MAILTO_EMAIL_TO'); ?></label>
			<div class="col-sm-10 col-xs-8">
				<input type="text" id="mailto_field" name="mailto" class="form-control" size="25" value="<?php echo $this->escape($data->mailto); ?>"/>
			</div>
		</div>
		<div class="form-group">
			<label for="sender_field" class="col-sm-2 col-xs-4 control-label">
		...
		<div class="form-group">
			<label for="from_field" class="col-sm-2 col-xs-4 control-label">
		...
		<div class="form-group">
			<label for="subject_field" class="col-sm-2 col-xs-4 control-label">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10 col-xs-offset-4">
