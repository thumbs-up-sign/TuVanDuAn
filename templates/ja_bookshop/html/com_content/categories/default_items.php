...
$class = ' class="category-item col-md-6 col-md-12 first"';
...
<div class="row">
	...
	if ($this->params->get('show_empty_categories_cat') || $item->numitems || count($item->getChildren())) :
		if (!isset($this->items[$this->parent->id][$id + 1])) {
			$class = ' class="category-item col-md-6 col-md-12 last"';
		}
		
		if ($id % 2 == 0) {
			$class = ' class="category-item col-md-6 col-md-12 first-col"';
		}
		?>
		<div<?php echo $class; ?>>
			<?php $class = ' class="category-item col-md-6 col-md-12"'; ?>
